        ...
        function valid_email() {
            ...
            for (i = 0; i < inputs.length; i++) {
                if ($(inputs[i]).val() == false) {
                    $(inputs[i]).removeClass("true_required");
                    $(inputs[i]).parent().addClass("false_required");
                    $(inputs[i]).after("<p class='message_false'>False</p>");
                    $(inputs[i]).next(".message_false").fadeIn();
                    end = false;
                } else if (!/^\w+\.?\-?\w+@\w+\.\w{2,4}$/i.test($(inputs[i]).val())) {
                    $(inputs[i]).removeClass("true_required");
                    ...
                    $(inputs[i]).removeClass("false_required").addClass("true_required");
