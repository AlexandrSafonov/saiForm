(function ($) {
    jQuery.fn.saiForm = function () {
        ...
        /* Input text */
        $(".saiForm").find("input[type='text'], textarea, input[type='password']").addClass("input_text");
        ...
        $(".saiForm button, .saiForm input[type='submit']").on("click", function (e) {
            e.preventDefault();
            ...
            if ($(thisForm).find(".number").length != false) {
